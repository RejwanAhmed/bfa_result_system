...
<?php
    function get_row_count()
    {
        ...
        $sql = "SELECT COUNT(`id`) as total_row FROM `external_member`";
    ...
    function display_content($run,$offset,$total,$page_number)
    {
        ...
        if(empty($run))
        {
            $all_external_details_qry = "SELECT * FROM `external_member` LIMIT $offset, $total";
            $run = mysqli_query($conn,$all_external_details_qry);
        }
        ?>
                ...
                while($row = mysqli_fetch_assoc($run))
                {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="modify_external_member.php?id=<?php echo $row['id']?>&page=<?php echo $page_number; ?>"><b><span><i class="far fa-edit"></i></span> Modify</b>
                            </a>
                            </button>
                        </td>
                        <td>
        ...
        <div class="col-lg-12 col-12">
            <div class="card">
                <div class="card-header form_header text-center">
                    <h2>External Member Information</h2>
                </div>
                <div class="card-body">
                    ...
                    <?php
                        if(isset($_POST['search']))
                        {
                            ...
                            if($name!=NULL)
                            {
                                $search_qry = "SELECT * FROM `external_member` WHERE `name` like '%$name%'";
                        ...
                        else
                        {
                            ...
                            <div class="col-lg-12 col-12">
                                <?php
                                $run = 0;
                                $page_name = 'view_external_member_information';
...
<script>
    function deleteConfirmation(id, page)
    {
        ...
        if(del == true)
        {
            window.location='delete_external_member.php?id='+id+'&page='+page;
        }
    }
</script>
