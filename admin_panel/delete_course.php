...
<?php
    ...
    if(isset($_GET['id']))
    {
        ...
        $id_validation_qry = "SELECT * FROM `course_information` WHERE `id` = '$_GET[id]'";
    ...
    if($num_rows==0)
    {
        $delete_qry = "DELETE FROM `course_information` WHERE `id` = '$id'";
        ...
        if($delete_qry_run)
        {
            ...
            <script type="text/javascript">
                ...
                window.location = "view_course_information.php?page=<?php echo $page; ?>";
            </script>
            <?php
        }
    }
    else
    {
        ?>
        <script type="text/javascript">
            window.alert("Sorry!! <?php echo $id_validation_qry_run_res['course_title'] ?> can not be deleted");
            window.location = "view_course_information.php?page=<?php echo $page; ?>";
        </script>
        <?php
    }
