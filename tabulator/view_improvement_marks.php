            ...
            <div class="card">
                <div class="card-header form_header text-center">
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <a class = "btn link_btn" href="course_wise_improvement_pdf.php?course_semester=<?php echo $_GET['course_semester'] ?>&course_id=<?php echo $_GET['course_id'] ?>&department_id=<?php echo $department_id ?>"><span><i class="fas fa-file-pdf"></i></span> Generate PDF</a>
                        </div>
                    </div>
                </div>
